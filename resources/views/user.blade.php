...
@section('konten')
    ...
    <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
        class="block mb-4 mt-3 text-white bg-orange-500 hover:bg-slate-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button">
        Add User
    </button>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <thead class="text-xs text-gray-700 uppercase bg-rose-600 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                                <button type="button" data-modal-target="authentication-modal{{ $p->id }}"
                                    ...
                                    class="text-white bg-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Update</button>
                            @endif
                    ...
                    <div id="authentication-modal{{ $p->id }}" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative w-full max-w-md max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    <h3 class="mb-4 text-xl font-medium text-rose-600 dark:text-white">Update User
                                    </h3>
                                    <form class="space-y-6" action="/user/storeupdate" method="POST">
                                        ...
                                        <div>
                                            <label for="name"
                                                class="block mb-2 text-sm font-medium text-slate-600 dark:text-white">Nama
                                            </label>
                                        ...
                                        <div>
                                            <label for="email"
                                                class="block mb-2 text-sm font-medium text-slate-600 dark:text-white mt-3">Email
                                            </label>
                                        ...
                                        <label for="password"
                                            class="block mb-2 text-sm font-medium text-rose-600 dark:text-white mt-3">Password
                                            <b>(*Jika kosong maka menggunakan password lama*)</b>
                                        </label>
                                        <input type="password" name="password" id=""
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                        <div class="my-3 space-y-2">
                                            <label for="" class="text-slate-600">Status</label>
                                            <select name="role" id="countries"
                                        ...
                                        <button type="submit"
                                            class="w-full  text-slate-50 bg-rose-600 hover:bg-slate focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Save Changes</button>
                                </div>
                                </form>
                            </div>
